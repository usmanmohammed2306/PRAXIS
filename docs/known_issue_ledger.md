...
- `python3 -m unittest tests.test_cargo -q`: 295 local regression tests passed.
...
- `python3 scripts/parse_smoke_results.py --smoke-summary outputs/smoke/smoke_summary_v2_corpus.json --json-out outputs/smoke/smoke_compact_v2_corpus.json`: passed.
